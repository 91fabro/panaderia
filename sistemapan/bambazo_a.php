...
<!-- <button type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil"></span> Star  </button> -->
  ...
  <div class="alert alert-info"><center> Lista de Gramos Registrados para Masa Bambazo </center> </div>
...
<!--  masa migajon   -->
 <button type="button" class="btn btn-info btn" data-toggle="modal" data-target="#masa_migajon">Masa de Bambazo</button></br>
 ...
 <div class="modal fade" id="masa_migajon" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Masa de Bambazo</h4>
             <p> Rellena la informacion Solicitada</p>
        </div>
        <div class="modal-body">
    <center>
...
echo $tipo=$_REQUEST['gramosp']; echo  $nomi=$_REQUEST['idpang'];
 $xsqla=mysqli_query($conexion,"SELECT * FROM masa_bambazo WHERE cantidad='1'");
 ...
 $gharina=$tipo* $uharina;$gazucar=$tipo* $uazucar;$gmanteca=$tipo* $uamanteca; $gagua=$tipo* $uagua; $gsal=$tipo* $usal;$glevadura=$tipo* $ulevadura;    


 $result = mysqli_query($conexion,"INSERT INTO  masa_bambazo(nombre_insumo,cantidad,Harina,azucar,manteca,sal,levadura,agua)
                                              VALUES ('$nomi','$tipo','$gharina','$gazucar','$gmanteca','$gsal','$glevadura','$gagua');");
...
*/
  ...
  <table  class="table table-hover"    id="tabla_lista_paises" >
    <thead >
      ...
      <th>Nombre </th>    <th>cantidad </th><th>Harina </th>  <th>Azucar </th> <th>Manteca</th>
    ...
    <tbody>
             ...
             $resultx = mysqli_query($conexion,"SELECT * FROM masa_bambazo ORDER BY  nombre_insumo ASC;");
       ...
       ?>      <tr>
             	   ...
             	   <td ALIGN='CENTER' width='100'><?php echo($row["manteca"]); ?> Gr </td><td ALIGN='CENTER' width='100'><?php echo($row["agua"]); ?> Gr </td>
